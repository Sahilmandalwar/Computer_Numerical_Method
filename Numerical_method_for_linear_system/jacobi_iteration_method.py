...
def gauss_jacobi_method(coefficient_variable,maxIter):
    ...
    for i in range(maxIter):
        ...
        new_y = (coefficient_variable[1][3] - coefficient_variable[1][0] * new_x - coefficient_variable[1][2] * initial_z) / coefficient_variable[1][1]
        new_z = (coefficient_variable[2][3] - coefficient_variable[2][0] * new_x - coefficient_variable[2][1] * new_y) / coefficient_variable[2][2]
...
print(gauss_seidal_method(coefficient_variable, maxIter))
